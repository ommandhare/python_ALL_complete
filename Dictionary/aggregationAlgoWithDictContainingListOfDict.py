...
for line in open(path):
    ...
    if(continent not in continentDict):
        countryList = []
        countryAttrib = {"name":countryName, "pop":population,"gdp":gdp}
...
for continentName,val in continentDict.items():
    print("\n\n***********************************")
    print("***************************************")
    for countryAttribDict in val:
        print("___________________________________")
        print("COUNTINENT NAME: ", continentName)
        print("COUNTRY NAME: ",countryAttribDict['name'])
        print("COUNTRY GDP: ",countryAttribDict['gdp'])
