...
def mockCurrentDates():
    ...
    print(tran_dtl)
    tran_dtl.to_csv(fr"C:\Users\HP\PycharmProjects\pythonProject.py\venv\Assignments\analysis_project\daily_files\tran_dtl_daily.csv",index=False)
    # tran_dtl.to_csv(r"tran_dtl_daily", index=False)
    ...
    # tran_hdr.to_csv(r"tran_hdr_daily", index=False)
