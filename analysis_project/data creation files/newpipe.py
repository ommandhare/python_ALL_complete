...
def run1():
    # Import and run your Python script logic
    import run1
    run1.run1()
...
# proc1 = subprocess.Popen(['python', 'code01.py'])
# print(111)
# proc2 = subprocess.Popen(['python', 'code02.py'])
# print(112)
# proc3 = subprocess.Popen(['python', 'code03.py'])
# print(113)
