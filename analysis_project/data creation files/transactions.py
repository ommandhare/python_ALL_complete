...
def mockCurrentDates():
    ...
    tran_dtl['tran_dt'] = pd.to_datetime(tran_dtl['tran_dt'])
    print(tran_dtl)
    tran_dtl.to_csv(r"C:\Users\sawan\OneDrive\CodeWork\Retail Loyalty Member Analytics\data\tran_dtl_daily.csv",index=False,header=False)
    ...
    tran_hdr['tran_dt'] = pd.to_datetime(tran_hdr['tran_dt'])
    print(tran_hdr)
    tran_hdr.to_csv(r"C:\Users\sawan\OneDrive\CodeWork\Retail Loyalty Member Analytics\data\tran_hdr_daily.csv",index=False,header=False)
    return
